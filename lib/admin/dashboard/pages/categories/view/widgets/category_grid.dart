...
import 'category_data_grid_source.dart';

late CategoryGridSource categoryDataSource;

class CategoryGrid extends SampleView {
  ...
  Widget _buildDataPager() {
    return SfDataPagerTheme(
      ...
      child: SfDataPager(
        ...
        visibleItemsCount: 5,
        pageCount: (categoryDataSource.tickets.length / _rowsPerPage).ceilToDouble(),
